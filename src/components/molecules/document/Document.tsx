...
const Document = () => {
  ...
  return isVisible && (
    ...
    >
      <CoolMode>
        <ShimmerButton onClick={() => downloadFile(portfolio, 'STEVEN_PORTFOLIO.pdf', location)} className='px-7 py-2'>
          Portfolio
        </ShimmerButton>
      </CoolMode>
      <CoolMode>
        <ShimmerButton onClick={() => downloadFile(cv, 'STEVEN_CV.pdf', location)} className='px-7 py-2'>
          CV
        </ShimmerButton>
      </CoolMode>
    </motion.div>
